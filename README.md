...
### Method: GET
>```
>localhost:5000/api/dashboard/admin
>```
...
### Method: PATCH
>```
>localhost:5000/api/books/update/:bookId
>```
### Body (**raw**)
...
### Method: PATCH
>```
>localhost:5000/api/books/update/62c6d3fd1fa4dd39f0c58a69
>```
### Body (**raw**)

```json
{
    "reviews":[{"userId": "62c48d92e348918233fb65a2", "review":"Very nice book"}]
}
```
...
### Method: POST
>```
>localhost:5000/api/cart/add/62c6d3701fa4dd39f0c58a66/
>```
### Body (**raw**)
...
### Method: GET
>```
>localhost:5000/api/cart/remove/62c6d3701fa4dd39f0c58a66
>```
